...
with open("vectors/toxic_vect.pkl", 'rb') as f:
    toxic = pickle.load(f)
with open("models/toxic_model.pkl", 'rb') as f:
    toxic_model = pickle.load(f)
with open("vectors/severe_toxic_vect.pkl", 'rb') as f:
    severe_toxic = pickle.load(f)
with open("models/severe_toxic_model.pkl", 'rb') as f:
    severe_toxic_model = pickle.load(f)
with open("vectors/threat_vect.pkl", 'rb') as f:
    threat = pickle.load(f)
with open("models/threat_model.pkl", 'rb') as f:
    threat_model = pickle.load(f)
with open("vectos/obscene_vect.pkl", 'rb') as f:
    obscene = pickle.load(f)
with open("models/obscene_model.pkl", 'rb') as f:
    obscene_model = pickle.load(f)
with open("vectors/insult_vect.pkl", 'rb') as f:
    insult = pickle.load(f)
with open("models/insult_model.pkl", 'rb') as f:
    insult_model = pickle.load(f)
with open("vectors/identity_hate_vect.pkl", 'rb') as f:
    identity_hate = pickle.load(f)
with open("models/identity_hate_model.pkl", 'rb') as f:
